...
if ($vars['status'] == 'draft') {
	$options_values = array('Off' => elgg_echo('off'));
} else {
...
$exec_content_label = elgg_echo('gc_theme:exec_content');
$exec_content = elgg_view('input/checkbox',array('name'=>'exec_content','value' => 'true','checked' => $checked));
...
<div>
	$exec_content
	<label for="exec_content">$exec_content_label</label>
</div>
<div class="elgg-foot">
