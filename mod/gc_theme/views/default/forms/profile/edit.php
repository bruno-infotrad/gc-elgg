	...
	if(!empty($cats)){
		...
		if($setting == "user" || elgg_is_admin_logged_in()){
			...
			if($types = elgg_get_entities($options)){
				...
				echo "<div onClick=\"cachee('privacy-statement')\">";
		...
		foreach($cats as $cat_guid => $cat){
			...
			$list_content .= "<div onClick=\"cachee('privacy-statement')\" id='" . $cat_guid . "' class='" . $class . "'>";
// 			if(count($cats) > 1){
...
// 			}
			...
			foreach($fields[$cat_guid] as $field){
				...
				if($hide_non_editables == "yes" && ($valtype == "non_editable")){
					...
					$field_result = "<div onClick=\"cachee('privacy-statement')\">";
				}	
...
<div id="privacy-statement" style="font-size:1em;color:red;font-weight:900;text-align:justify;">
<p>
	<?php echo elgg_echo('privacy-statement'); ?>
</p>
</div>
<div onClick="cachee('privacy-statement')">
...
<div onClick="cachee('privacy-statement')">
	...
	<?php
		$params = array(
			'name' => $shortname,
			'value' => $value,
			'onfocus' => "cachee('privacy-statement')",
		);
