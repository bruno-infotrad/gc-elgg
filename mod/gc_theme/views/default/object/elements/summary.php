...
$post_button = elgg_extract('post_button', $vars, '');
...
if ($post_button) {
	echo "<div class=\"elgg-subtext elgg-subtext-friendsof-title\">$subtitle</div>";
	echo "<div class=\"elgg-subtext elgg-subtext-friendsof\">$post_button</div>";
} else {
