...
echo "<div class=\"gc-file-name\">$title_link<div class=\"elgg-subtext\">$subtitle</div></div>";
echo "<div class=\"gc-file-date-created\">".date(EVENT_MANAGER_FORMAT_DATE_EVENTDAY,$entity->time_created)."</div>";
echo $tags;
