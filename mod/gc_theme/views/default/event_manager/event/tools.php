<?php 
	...
	$toolLinks .= "<li>" . elgg_view("output/url", array("is_action" => true, "href" => "action/event_manager/notify_colleagues?guid=" . $event->getGUID(), "text" => elgg_echo("event_manager:event:notify_colleagues"))) . "</li>";
