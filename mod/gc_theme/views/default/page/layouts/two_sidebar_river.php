...
<div class="<?php echo $class; ?>">
	...
	<div class="elgg-sidebar-alt-river">
		<?php if (elgg_is_logged_in()) {?>
			<?php echo elgg_view('page/elements/online_friends', $vars); ?>
			<?php echo elgg_view('page/elements/online_users', $vars); ?>
			<?php echo elgg_view('page/elements/sidebar_alt_river_activity', $vars); ?>
			<?php echo elgg_view('page/elements/popular_discussions', $vars); ?>
			<?php echo elgg_view('page/elements/popular_groups', $vars); ?>
		<?php }?>
	</div>
</div>
