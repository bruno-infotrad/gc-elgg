...
// Need to modify each river item to allow this variable to pass :-(
$elgg_body_class="elgg-body";
$body_class = elgg_extract('body_class',$vars,'');
if ($body_class) {
	$elgg_body_class=$elgg_body_class." ".$body_class;
}
$body = "<div class=\"$elgg_body_class\">$body</div>";
