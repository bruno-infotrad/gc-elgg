<p>
    ...
    <fieldset style="border: 1px solid; padding: 15px; margin: 0 10px 0 10px">
        <legend><?php echo elgg_echo('gc_theme:settings:motd');?></legend>
        
        <label for="params[motd]"><?php echo elgg_echo('gc_theme:settings:label:motd');?></label><br/>
	<?php echo elgg_view("input/longtext", array("name" => "params[motd]", "value" => $vars['entity']->motd)); ?>
        <label for="params[motd_url]"><?php echo elgg_echo('gc_theme:settings:label:motd_url');?></label><br/>
	<?php echo elgg_view("input/text", array("name" => "params[motd_url]", "value" => $vars['entity']->motd_url)); ?>
        <label for="params[motd_display_expiry]"><?php echo elgg_echo('gc_theme:settings:label:motd_display_expiry');?></label><br/>
	<?php echo elgg_view("input/text", array("name" => "params[motd_display_expiry]", "value" => $vars['entity']->motd_display_expiry)); ?>
        <label for="params[motd_display_duration]"><?php echo elgg_echo('gc_theme:settings:label:motd_display_duration');?></label><br/>
