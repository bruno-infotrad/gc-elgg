...
//Fix for not showing "likes" when users join group
if ($vars['item']->type == "group" && $vars['item']->view != "river/group/create") {
                        return true;
}
...
$likes_module = elgg_view_module('popup', elgg_echo('gc_theme:Likes'), $likes_list, array('class' => 'hidden elgg-likes-list', 'id' => "likes-$guid"));
