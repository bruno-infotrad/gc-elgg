...
elgg.thewire.init = function() {
	$("#thewire-textarea").live('keydown', function() {
		elgg.thewire.textCounter(this, $("#thewire-characters-remaining span"));
	});
 ...
 * @return void
 */
elgg.thewire.textCounter = function(textarea, status) {

	var typed_chars = $(textarea).val().length;
	status.html(typed_chars);
