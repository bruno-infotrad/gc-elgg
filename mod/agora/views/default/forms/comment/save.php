...
if ($comment && $comment->canEdit()) {
	...
	$submit_input = elgg_view('input/submit', array('value' => elgg_echo("generic_comments:edit"), 'class' => 'agora-submit-button'));
	$comment_text = $comment->description;
} else {
	$comment_label  = elgg_echo("generic_comments:add");
	$submit_input = elgg_view('input/submit', array('value' => elgg_echo("generic_comments:add"), 'class' => 'agora-submit-button'));
}
