...
$form_data .= "<div>" . elgg_echo("agora:intro:join_group:description") . "</div>";
...
$form_data .= elgg_view('input/submit', array('name' => 'submit', 'value' => elgg_echo('agora:intro:join_group:button')));
$form_data .= '</div>';
echo $form_data;
?>
