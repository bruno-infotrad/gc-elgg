        ...
        if (elgg.is_logged_in()) {
			...
			switch(context){
				case 'search':
					...
					ajax_path = 'ajax/view/agora/ajax/'+path_atoms;
					break;
				case 'dashboard':
					iteration++;
					...
					ajax_path ='ajax/view/agora/ajax/dashboard';
					break;
				case 'friends':
					iteration++;
					delete_marker = elgg.delete_marker(count,iteration,20);
					...
					//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset);
					params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/friends';
					break;
				case 'friendsof':
					iteration++;
					delete_marker = elgg.delete_marker(count,iteration,20);
					...
					//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset);
					params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/friendsof';
					break;
				case 'members':
					iteration++;
					if (page_type == 'all') {
					...
					params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
					if (page_type == 'search') {
						ajax_path = 'ajax/view/agora/ajax/members/search/'+path_atoms[2];
					} else {
						ajax_path = 'ajax/view/agora/ajax/members';
					}
					break;
				case 'bookmarks':
					if (page_type == 'group') {
				...
				case 'file':
					if (page_type == 'all') {
						...
						//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset);
						params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
						ajax_path = 'ajax/view/agora/ajax/file_world';
						...
						ajax_path = 'ajax/view/agora/ajax/file_friends?offset='+new_offset;
						...
						//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset);
						params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
						ajax_path = 'ajax/view/agora/ajax/file_owner';
					}
					break;
				case 'pages':
					if (page_type == 'all') {
						...
						//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset);
						params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
						ajax_path = 'ajax/view/agora/ajax/pages_world';
					} else if (page_type == 'friends') {
						iteration++;
						delete_marker = elgg.delete_marker(count,iteration,10);
						new_offset = parseInt(offset) + 10;
						...
						params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
						//Offset only obtained from get_input, not from options - blah
						ajax_path = 'ajax/view/agora/ajax/pages_friends?offset='+new_offset;
					} else if (page_type == 'owner') {
						iteration++;
						delete_marker = elgg.delete_marker(count,iteration,10);
						new_offset = parseInt(offset) + 10;
						...
						//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset);
						params = {'base_url': base_url,'page_type': page_type,'owner': owner, 'offset': new_offset};
						ajax_path = 'ajax/view/agora/ajax/pages_owner';
				...
				case 'groups':
					if (page_type == 'profile') {
						...
						//console.log('more_url='+more_url);
						params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
						ajax_path = 'ajax/view/agora/ajax/group_wall';
						...
						//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
						params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
						ajax_path = 'ajax/view/agora/ajax/group_members';
						...
						ajax_path = 'ajax/view/agora/ajax/allgroups';
					}
					break;
				case 'polls':
					var group_guid = path_atoms[2];
					...
					//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
					params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/polls';
					break;
				case 'blog':
					var group_guid;
					if (page_type == 'group') {
					...
					//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
					params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/blogs';
					break;
				case 'thewire':
				case 'thewire_group':
					var group_guid;
					...
					//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
					params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/thewire';
					break;
				case 'messages':
					if (page_type == 'inbox') {
						owner = path_atoms[2];
					...
					//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
					params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/messages_inbox';
					break;
				case 'site_notifications':
					...
					//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
					params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/site_notifications';
					break;
				case 'embed':
					...
					params = {'base_url': base_url,'group_guid': group_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
					ajax_path = 'ajax/view/agora/ajax/embed';
					break;
				case 'ajax':
					if  (path_atoms[2] == 'profile') {
						...
						if (args[0] == 'user_groups') {
							...
							ajax_path = 'ajax/view/agora/ajax/user_groups';
							...
							//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
							params = {'base_url': base_url,'container_guid': container_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
							ajax_path = 'ajax/view/agora/ajax/user_activity';
							...
							//console.log('base_url='+base_url+' context='+context+' page_type='+page_type+' owner='+owner+' offset='+offset+' group_guid='+group_guid);
							params = {'base_url': base_url,'container_guid': container_guid, 'page_type': page_type, 'owner': owner, 'offset': new_offset};
							ajax_path = 'ajax/view/agora/ajax/user_colleagues';
						}
					}
					break;
			};
...
elgg.more_url = function(base_url,context,page_type,owner,offset,count,iteration){
	var concat='?';
	var pagination_more='<?php echo elgg_echo('agora:more'); ?>';
	var patt=new RegExp("\\?");
