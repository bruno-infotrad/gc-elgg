...
elgg.toggle_long_posts.activate = function() {
	...
	//var showMoreText = '&nbsp;&nbsp;&nbsp; '+elgg.echo("agora:more",elgg.get_logged_in_user_entity().language), showLessText = '&nbsp;&nbsp;&nbsp; '+elgg.echo("agora:less",elgg.get_logged_in_user_entity().language),
	// var showMoreText = '&nbsp;&nbsp;&nbsp; <?php echo elgg_echo("agora:more"); ?>',
	//showLessText = '&nbsp;&nbsp;&nbsp; <?php echo elgg_echo("agora:less"); ?>',
