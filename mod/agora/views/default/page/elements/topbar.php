...
$advanced = elgg_echo('agora:advanced');
$feedback = elgg_echo('agora:feedback');
$feedback_url = "${site_url}groups/profile/17712/tell-us-how-we-can-improve-agora-ditesnous-comment-amliorer-agora";
$object_label = elgg_echo('agora:object');
$all_label = elgg_echo('agora:all_objects');
...
$all_agora_label = elgg_echo('agora:agora_all');
$groups_agora_label = elgg_echo('agora:agora_groups');
$users_agora_label = elgg_echo('agora:agora_users');
$contributed_by_label = elgg_echo('agora:contributed_by');
$approximate_date_label = elgg_echo('agora:approximate_date');
...
$(document).ready(function() {
	...
	$("#srch").live('keyup', function(){
	        if ($.trim($("#srch").val())) {
			$('#search-submit-button .button-text').css('background','url(mod/agora/views/default/images/icon-search-active.png) no-repeat 0 0');
			...
			$('#search-submit-button').css('pointer-events','none');
			$('#search-submit-button .button-text').css('background','url(mod/agora/views/default/images/icon-search-inactive.png) no-repeat 0 0');
			$('#search-submit-button').attr('disabled','disabled');
			$('#advanced-search-submit-button').css('opacity','0.5');
			$('#advanced-search-submit-button').css('pointer-events','none');
			$('#advanced-search-submit-button').attr('disabled','disabled');
