...
if (1) {
	...
	echo elgg_view('output/url', array('class'=>'gc-scroll', 'href'=>$base_url,'text'=>elgg_echo('agora:more'),'rel' => 'nofollow','onclick'=>"elgg.scroll(\"$base_url\",\"$context\",\"$page_type\",\"$owner->username\",\"$offset\",\"$count\",\"$iteration\",\"$already_viewed\");return false;"));
}else{
	if ($pages->prev['href']) {
