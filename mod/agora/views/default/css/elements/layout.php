...
#agora-avatar-upload .elgg-button-submit,
#agora-intro-uploadavatar .elgg-button-submit {
	float: right;
	margin-right: 20%;
}
#agora-avatar-upload .elgg-button-submit,
#agora-avatar-upload .input-file,
#agora-intro-uploadavatar .elgg-button-submit,
#agora-intro-uploadavatar .input-file {
	display: inline-block;
}

#agora-avatar-upload .elgg-image-block>.elgg-body {width: 70%;}
#agora-intro-uploadavatar .elgg-image-block>.elgg-body {width: 50%;}
#agora-intro-uploadavatar {height: 240px;width: 450px;}
#intro-join-group {width: 300px;}
#agora-parent-folder-label {
