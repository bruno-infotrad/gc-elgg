...
.gc-ui-icon, .ui-icon, .ui-widget-content .ui-icon {
    background-image: url('<?php echo elgg_get_site_url();?>/mod/agora/views/default/images/themeroller-icon-set-vector-20px-2010-06-01.png');
...
.dropdown > i {
	...
	top: 0;
	z-index: 10;
	background: url(<?php echo elgg_get_site_url(); ?>mod/agora/views/default/images/menu-toggle-indicator.png) no-repeat 0 0;
	cursor: pointer;
}
.invitations-exist #elgg-expandable.elgg-menu-parent {
	background: url(<?php echo elgg_get_site_url(); ?>mod/agora/views/default/images/menu-toggle-indicator-alert.png) no-repeat 0 0;
}
