...
.is-locked-autocomplete {
    background: url(<?php echo elgg_get_site_url(); ?>mod/agora/views/default/images/icon-locked-lrg.png) no-repeat 100% 0;
...
.agora-view-file>.elgg-content>.elgg-image-block>.elgg-body {
    max-width: 100%;
}
