					...
					<ul>
						...
						<li id="gcwu-gcnb-lang"><a href="javascript:form_submit()" lang="fr">Français</a></li>
                            ...
                            <div id="gcwu-gcnb-fip">
                                <div id="gcwu-sig">
                                    <div id="gcwu-sig-in">
                                        <object data="<?php echo $site_url;?>mod/agora/views/default/agora/dist/theme-gcwu-intranet/images/sig-static-eng.svg" 
                                                role="img" 
                                                tabindex="-1" aria-label="Government of Canada" type="image/svg+xml" 
                                                width="217" height="24">
                                            <div id="gcwu-sig-eng" title="Government of Canada"><img 
                                                    src="<?php echo $site_url;?>mod/agora/views/default/agora/dist/theme-gcwu-intranet/images/sig-eng.png" width="215" 
