...
echo elgg_view_form('agora/notify_groups', array(), array('group_list' => $content, 'event_guid' => $event_guid ));
...
$('body').on('click','.elgg-form-agora-notify-groups', function() {
	if ($('.elgg-form-agora-notify-groups input[type=checkbox]').is(':checked')){
