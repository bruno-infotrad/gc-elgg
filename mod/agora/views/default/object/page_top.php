...
if ($revision) {
	...
	$annotation = $page->getAnnotations(array( 'annotation_name' => 'page', 'limit' => 1, 'reverse_order_by' => true,));
	if ($annotation) {
...
if ($full) {
	...
	echo elgg_view_image_block($page_icon, $list_body,array('class' => 'gc-page-list'));
}
