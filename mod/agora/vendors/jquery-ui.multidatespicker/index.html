		...
		<div id="page">
			...
			<div id="ribbons">
				<a href="http://github.com/dubrox/Multiple-Dates-Picker-for-jQuery-UI" style="display:block; position: absolute; top: -3px; left: -3px; border: 0;">
					<img style="border: 0;" src="img/github-fork-ribbon.png" alt="Fork me on GitHub">
				</a>
			</div>
			...
			<div id="share">
				...
				<div id="tweet" style="padding-top: .5em;">
					<a href="http://twitter.com/share" class="twitter-share-button" data-count="vertical" data-url="http://multidatespickr.sourceforge.net/" data-text="MultiDatesPicker">Tweet</a>
					<script type="text/javascript">
						$('#tweet a').attr('data-text','MultiDatesPicker v' + latestMDPver);
					</script>
	...
	beforeShowDay: $.datepicker.noWeekends
					...
					<li class="demo">
						...
						<div id="withAltField" class="box">
							...
							<input type="text" id="altField" value="09/19/2014, 09/21/2014">
						</div>
						<p class="description">
