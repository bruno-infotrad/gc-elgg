...
return array(
	...
	'polls:settings:status' => "Status",
	'polls:open' => "Open",
	'polls:closed' => "Closed",
	'polls:closedlongtext' => "This poll is now closed",
 ...
 */
	'poll:notify_new_poll' => 'A new poll has been posted',
	'polls:notify:summary' => 'New poll called %s',
	'polls:notify:subject' => "A new poll: %s",
	'polls:notify:body' =>
'%s added a new poll: %s

%s

View and comment on the poll:
%s
',
/**
 * Error messages
